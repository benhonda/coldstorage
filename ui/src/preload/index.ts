...
const api: ColdstoreApi = {
  ...
  cancelCheckout: () => ipcRenderer.invoke(IPC.entitlementCancelCheckout),
  ...
  reopenRestoreCheckout: () => ipcRenderer.invoke(IPC.retrievalReopenCheckout),
  cancelRestorePayment: (jobId: string) => ipcRenderer.invoke(IPC.retrievalCancelPay, jobId),
