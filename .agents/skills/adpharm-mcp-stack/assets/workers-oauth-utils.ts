...
//
// Engine — copy verbatim (adpharm-mcp-stack skill). Self-contained: one type-only import,
// Web-standard APIs otherwise. From silo-cdp-mcp; matches Cloudflare's
// securing-mcp-servers guidance (createOAuthState / bindStateToSession).
